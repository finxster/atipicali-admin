        ...
        >
          ...
          <div class="border-b border-gray-200 px-4 sm:px-6 py-3 sm:py-5">
            <div class="flex items-center justify-between">
              <div>
                <h2 class="text-lg sm:text-2xl font-bold text-gray-900">{{ t('serviceTypes.add.title') }}</h2>
                <p class="text-xs sm:text-sm text-gray-500 mt-1">{{ t('serviceTypes.add.subtitle') }}</p>
              </div>
              <button
                @click="handleClose"
